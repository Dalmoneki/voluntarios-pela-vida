...
import { LayoutGrid, Users2, ArrowLeftRight, Package, Wallet, Bell, FileText, Menu, X } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/cadastros', icon: Users2, label: 'Cadastros', color: 'text-orange-500' },
  { href: '/movimentacao', icon: ArrowLeftRight, label: 'Movimentação', color: 'text-green-500' },
  { href: '/estoque', icon: Package, label: 'Controle de Estoque', color: 'text-purple-500' },
  { href: '/caixa', icon: Wallet, label: 'Controle de Caixa', color: 'text-yellow-500' },
  { href: '/alertas', icon: Bell, label: 'Alertas', color: 'text-blue-500' },
  { href: '/relatorios', icon: FileText, label: 'Relatórios', color: 'text-gray-500' },
]
